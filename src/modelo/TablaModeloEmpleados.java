 ...
 * @author DrowSoft
 */
public class TablaModeloEmpleados extends AbstractTableModel {

    private String[] columnNames = {"Cédula", "Nombre", "Cargo"};//Creamos las columnas necesarias
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 2:
                return empleados.get(rowIndex).getCargo();//Pasamos el cargo del empleado
            default:
                return null;
        }
    }
...
//        return getValueAt(0, columnIndex).getClass();
    ...
    public void setValueAt(Object value, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                empleado.setCargo((String) value);
        }
