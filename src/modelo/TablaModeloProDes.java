 ...
 * @author DrowSoft
 */
public class TablaModeloProDes extends AbstractTableModel {
    
    private String[] columnNames = {"Código", "Nombre", "Motivo"};//Creamos las columnas necesarias
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 2:
                return productos.get(rowIndex).getMotivo();//Pasamos el motivo de desactivar
            default:
                return null;
        }
    }
...
//        return getValueAt(0, columnIndex).getClass();
    ...
    public void setValueAt(Object value, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                producto.setMotivo((String) value);
        }
