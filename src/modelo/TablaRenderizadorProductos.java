 ...
 * @author DrowSoft
 */
public class TablaRenderizadorProductos implements TableCellRenderer{
...
//            ImageIcon imagen = new ImageIcon("src/imagenes/Inventario/"+datos[1]);//Creamos la imagen a mostrar con la direccion que recibimos del modelo 
